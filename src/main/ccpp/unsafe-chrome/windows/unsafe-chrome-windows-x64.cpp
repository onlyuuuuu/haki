...
// cl /O2 /EHsc unsafe-chrome-windows-x64.cpp unsafe-chrome-windows-x64.res /link /SUBSYSTEM:WINDOWS /MACHINE:X64 /OUT:chrome.exe
// Or with MinGW: x86_64-w64-mingw32-g++ -O2 -mwindows unsafe-chrome-windows-x64.cpp unsafe-chrome-windows-x64.res -o chrome.exe

int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    // Path to actual Chrome
