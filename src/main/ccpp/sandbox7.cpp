...
static set<int>                                                            unique_set;
static set<int, greater<int>>                                              unique_set_desc;
static multiset<int>                                                       non_unique_set;
static multiset<int, greater<int>>                                         non_unique_set_desc;
static set<int, decltype(compare_for_max_or_asc)>                          index_unique_set(compare_for_max_or_asc);
static set<int, decltype(compare_for_min_or_desc)>                         index_unique_set_desc(compare_for_min_or_desc);
static multiset<int, decltype(compare_for_max_or_asc)>                     index_non_unique_set(compare_for_max_or_asc);
static multiset<int, decltype(compare_for_min_or_desc)>                    index_non_unique_set_desc(compare_for_min_or_desc);
